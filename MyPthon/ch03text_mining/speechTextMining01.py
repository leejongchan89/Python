...
# 단어 정의 사전
# 사용자가 최소 형태소를 커스텀마이징 하려면, 이 파일에 기록해 두세요.
...
difference = set_old_token.difference(set_new_token) # 차집합

print('불용어로 처리된 목록')
print(difference)

import nltk # national Language toolkit (자연서 처리 툴킷)
...
barCount = 10
chartData = myFrame.set_index('단어').iloc[0:barCount] # 단어 컬럼을 인덱스로 옮기기 .set_index
print(chartData)
